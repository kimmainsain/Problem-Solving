...
public class Main {
    ...
    public static void recur(int depth) {
        ...
        sb.append("____".repeat(depth)).append("마을 사람들은 모두 그 선인에게 수많은 질문을 했고, 모두 지혜롭게 대답해 주었지.\n");
        sb.append("____".repeat(depth)).append("그의 답은 대부분 옳았다고 하네. 그런데 어느 날, 그 선인에게 한 선비가 찾아와서 물었어.\"\n");
        recur(depth + 1);
        sb.append("____".repeat(depth)).append("라고 답변하였지.\n");
    }
